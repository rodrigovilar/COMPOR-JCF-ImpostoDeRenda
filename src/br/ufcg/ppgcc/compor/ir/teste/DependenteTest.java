...
public class DependenteTest {
	...
	public void T_03_01_novoDependente() {
		...
		DependenteHelper.verificaCriacaoDependentes(fachada, titular,
				dependente);
	}
	...
	public void T_03_03_doisDependentesUmEmCadaTitular() {
		...
		DependenteHelper.verificaCriacaoDependentes(fachada, titular1,
				dependente1);
		DependenteHelper.verificaCriacaoDependentes(fachada, titular2,
				dependente2);
	}
